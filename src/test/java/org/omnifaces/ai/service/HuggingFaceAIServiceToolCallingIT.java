...
@EnabledIfEnvironmentVariable(named = HuggingFaceAIServiceToolCallingIT.API_KEY_ENV_NAME, matches = ".+")
class HuggingFaceAIServiceToolCallingIT extends BaseAIServiceToolCallingIT {
