...
@EnabledIfEnvironmentVariable(named = MetaAIServiceTextAnalyzerIT.API_KEY_ENV_NAME, matches = ".+")
class MetaAIServiceTextAnalyzerIT extends BaseAIServiceTextAnalyzerIT {
