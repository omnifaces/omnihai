...
@EnabledIfEnvironmentVariable(named = HuggingFaceAIServiceTextAnalyzerIT.API_KEY_ENV_NAME, matches = ".+")
class HuggingFaceAIServiceTextAnalyzerIT extends BaseAIServiceTextAnalyzerIT {
