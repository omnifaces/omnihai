...
@EnabledIfEnvironmentVariable(named = OpenRouterAIServiceAudioGeneratorIT.API_KEY_ENV_NAME, matches = ".+")
class OpenRouterAIServiceAudioGeneratorIT extends BaseAIServiceAudioGeneratorIT {
