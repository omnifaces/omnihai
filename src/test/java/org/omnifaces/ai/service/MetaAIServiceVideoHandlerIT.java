...
@EnabledIfEnvironmentVariable(named = MetaAIServiceVideoHandlerIT.API_KEY_ENV_NAME, matches = ".+")
class MetaAIServiceVideoHandlerIT extends BaseAIServiceVideoHandlerIT {
