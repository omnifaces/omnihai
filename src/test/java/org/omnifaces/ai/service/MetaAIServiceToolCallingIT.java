...
@EnabledIfEnvironmentVariable(named = MetaAIServiceToolCallingIT.API_KEY_ENV_NAME, matches = ".+")
class MetaAIServiceToolCallingIT extends BaseAIServiceToolCallingIT {
