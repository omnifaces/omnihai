...
@EnabledIfEnvironmentVariable(named = AzureAIServiceToolCallingIT.API_KEY_ENV_NAME, matches = ".+")
class AzureAIServiceToolCallingIT extends BaseAIServiceToolCallingIT {
