...
@EnabledIfEnvironmentVariable(named = AzureAIServiceVideoGeneratorIT.API_KEY_ENV_NAME, matches = ".+")
class AzureAIServiceVideoGeneratorIT extends BaseAIServiceVideoGeneratorIT {
    ...
    protected GenerateVideoOptions getOptions() {
        return GenerateVideoOptions.newBuilder().size("480x480").seconds(5).build();
    }
