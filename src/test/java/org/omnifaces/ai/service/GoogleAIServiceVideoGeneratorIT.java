...
@EnabledIfEnvironmentVariable(named = GoogleAIServiceVideoGeneratorIT.API_KEY_ENV_NAME, matches = ".+")
class GoogleAIServiceVideoGeneratorIT extends BaseAIServiceVideoGeneratorIT {
